...
class AddPonkaToImageHandler implements MessageHandlerInterface, LoggerAwareInterface
{
    ...
    public function __construct(PhotoPonkaficator $photoPonkaficator, PhotoFileManager $photoManager, EntityManagerInterface $entityManager, ImagePostRepository $imagePostRepository)
    {
